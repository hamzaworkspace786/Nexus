...
import { Mail, Lock, User, CheckCircle2, Sparkles, AlertCircle, Loader2 } from "lucide-react";
        ...
        <div className="min-h-screen w-full flex flex-col lg:flex-row bg-slate-950 text-slate-50 font-sans">
            ...
            >
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    >
                        Join the <span className="text-secondary italic">next generation</span> of team flow.
                    </motion.h1>

                    <div className="space-y-6 mt-12">
                        {[
                            "Real-time multiplayer canvas",
                            "Integrated high-fidelity voice calls",
                            "AI-powered shape recognition",
                            "Infinite asset library & templates"
                        ].map((feature, idx) => (
                            <motion.div
                                key={idx}
            ...
            >
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl font-black tracking-tight mb-2">Create an account</h2>
